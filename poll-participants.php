            ...
            <div class="dashboard-main">
                ...
                <div class="inner-dashboard-main" id="inner-dashboard-main">
                    ...
                    <form method="post" action="" style="padding:8px 12px">
                        ...
                        <div style="margin:6px"><?=$participant_added?></div>
                        ...
                        <a href="/poll-options.php?user=<?=$user?>&poll=<?=$poll?>" style="background-color:#5a3e8d;border-radius:4px;padding:3px 6px;color:#fff">
                            Enter/Edit Poll Options
                        </a>
                    </form>
                    <!--Main Content ends-->
